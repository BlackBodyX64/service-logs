...
const challenge = (method: string, url: string, data: any = null) => new Promise((resolve, reject) => {
    axios({ method, url, data, timeout: 5000 * 10 }).catch(error => {
...
const HikIsApiRequest = async (method: string, base: string, uri: string, username: string, password: string, data: any = null) => {
    ...
    return axios({ method, url, data, headers: { Authorization: authorization }, timeout: 10000 * 10 })
}
...
const HikIsImageRequest = async (method: string, base: string, uri: string, username: string, password: string, data: any = null) => {
    ...
    return axios({ method, url, data, headers: { Authorization: authorization, Accept: accept, 'Accept-Encoding': "gzip, deflate" }, timeout: 10000 * 10, responseType: 'arraybuffer' })
}
